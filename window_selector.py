...
class WindowSelector:
    ...
    def start_selection(self):
        ...
        Returns:
            bool: True if selection process started successfully
        """
    ...
    def check_selected_window(self, tracked_programs):
        ...
        Args:
            tracked_programs (dict): Dictionary of currently tracked programs

        Returns:
            tuple or None: 
                - (process_name, is_new) where:
                  - process_name (str): Executable name of the foreground window
                  - is_new (bool or str): True if the program is not yet tracked and can be added,
                    False if it is already being tracked. Can also be 'MAX_REACHED',
                    'ERROR', or 'NO_WINDOW' to indicate specific conditions
