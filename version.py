...
# Version information
VERSION = "0.0.3"  # Current version based on CHANGELOG.md
VERSION_DATE = "2025-07-14"  # Release date from CHANGELOG.md
...
def get_version_string(include_date=False):
    ...
    Args:
        include_date (bool, optional): Whether to include the release date. Defaults to False.
